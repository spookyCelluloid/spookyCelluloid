...
const FacilityProfile = ({currentProfile}) => (
  ...
  <div>
    <div className='title'>
      <h2 className='facilityName'>{currentProfile.facility_name}: {currentProfile.reviews[0].rating} stars</h2>
    </div>
    ...
    <div className='reviews'>
      {currentProfile.reviews.map((review) => {
        return (
          <div>
            <p className='reviewName'>{review.first_name} {review.last_name} {review.rating} stars</p>
